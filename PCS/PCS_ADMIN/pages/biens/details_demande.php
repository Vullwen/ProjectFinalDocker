...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    ...
    $getDemandesQuery = $databaseConnection->query("SELECT id, type_conciergerie, autre_conciergerie, adresse, pays, type_bien, type_location, nombre_chambres, capacite, nom, telephone, email, heure_contact, etat FROM demandebailleurs WHERE id = " . $_GET['id'] . "");
                ...
                <tbody>
                    <?php while ($demande = $getDemandesQuery->fetch(PDO::FETCH_ASSOC)):
                        ...
                        <tr>
                            ...
                            <td><a href="accept_demande.php?id=<?php echo htmlspecialchars($demande['id']); ?>">Accepter la
                                    demande</a>
                                <a href="refuse_demande.php?id=<?php echo htmlspecialchars($demande['id']); ?>">Refuser la
                                    demande</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
